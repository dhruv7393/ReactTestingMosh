...
- we created an account on auth0 and added credentials to .ev.local
- concurrently helps to simultaneously run front and back end in parallel
- RTL helps to render component and test just like end user
- To install - `npm i -D @testing-library`
- By default test are run in node env which has no idea of browser dom. Hence JSDom/HAppyDom is used. `npm i -D jsdom`
- vitest is configured to use jsdom with `environment: "jsdom",`
